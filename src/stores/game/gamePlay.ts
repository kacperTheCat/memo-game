...
import { cloneMemoryStateShallow } from '@/game/memory/sfxPickOutcomes'
import { gridDimensions } from '@/game/canvas/buildGridLayout'
import { MISMATCH_RESOLVE_MS } from '@/game/tiles/tileMotionConstants'

export { MISMATCH_RESOLVE_MS } from '@/game/tiles/tileMotionConstants'
...
export const useGamePlayStore = defineStore('gamePlay', () => {
  ...
  function hydrateFromSnapshot(
    ...
    difficulty: import('@/game/library/tileLibraryTypes').Difficulty,
  ): void {
    clearMismatchTimer()
